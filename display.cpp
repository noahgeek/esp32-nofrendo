...
/* ST7789 240x240: SDA=GPIO6, SCK=GPIO4, DC=GPIO1, RES=GPIO7, BLK=GPIO5 */
Arduino_DataBus *bus = new Arduino_ESP32SPI(1 /* DC */, -1 /* CS */, 4 /* SCK */, 6 /* MOSI */, -1 /* MISO */);
Arduino_ST7789 *gfx = new Arduino_ST7789(bus, 7 /* RST */, 1 /* rotation */, true /* IPS */, 240, 240, 0, 0);
